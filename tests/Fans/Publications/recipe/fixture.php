...
use Faluss\Platform\Fans\Publications\TextPublicationSchema;
use Faluss\Platform\Fans\Sso\FansSsoSchema;

if (!TextPublicationsModule::available() || !TextPublicationSchema::installOrVerify()) {
...
$directory = '/var/tmp/faluss-text-publications-proof';
