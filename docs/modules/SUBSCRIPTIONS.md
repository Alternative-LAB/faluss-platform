...
La bascule Platform a été réalisée le 23 septembre 2026 avec rapprochement des huit tables, du schéma version `2` et du Cron quotidien. Stripe reste volontairement fermé : les paramètres TEST ne sont pas configurés sur le serveur. Cette limitation préexistante est consignée dans le rapport de migration ; aucun secret live ou fictif n'a été ajouté.
