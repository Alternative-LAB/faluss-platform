...
| Admission des textes, lot présent | Implémenté dans cette PR brouillon, sans activation de production | Quotas serveur par créateur sur créations et éditions ; clé de création idempotente, verrou concurrent et schéma privé v2. Recette WordPress/MariaDB locale incluant pagination, concurrence et rejeux. |
