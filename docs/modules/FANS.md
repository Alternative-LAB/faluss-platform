...
La [simulation Progression/HoF](PROGRESSION-SIMULATION.md) teste les corrections sur faits fictifs. Elle ne crée ni niveau, badge, session HoF, PF, revenu ou score actif.
