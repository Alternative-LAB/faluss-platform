...
| Admission des textes, PR #75 | Fusionné, sans activation de production | Quotas serveur par créateur sur créations et éditions ; clé de création idempotente, verrou concurrent et schéma privé v2. Recette WordPress/MariaDB locale incluant pagination, concurrence et rejeux. |
...
| Affichage JPEG Fans, lot présent | Implémenté dans cette PR brouillon, flag distinct fermé | Dérivé en mémoire ; texte, association, image et profil revérifiés par demande. Aucune diffusion sur Me, original ou CDN. Voir [FANS-IMAGE-DELIVERY.md](FANS-IMAGE-DELIVERY.md). |
...
2. **Social et contenu** : profils et suivi local sont fusionnés. #74 a ajouté les textes modérés, leur retrait et leur pagination. #75 a fiabilisé leur admission avec quotas et idempotence. #76 a ajouté la quarantaine privée d’images. #77 a relié ces images approuvées aux textes par référence privée. Le lot présent ajoute un dérivé JPEG à la demande, derrière un flag de diffusion distinct, sans activation de production. Médias, messagerie, blocage, signalement, suppression de compte, rétention automatique et outillage de modération restent à construire. La quarantaine privée et la revue humaine ne garantissent pas la détection de tout contenu interdit ; aucune ouverture de production n'est autorisée par cette recette.
