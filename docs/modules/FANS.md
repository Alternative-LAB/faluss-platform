...
| Associations image–texte, lot présent | Implémenté dans cette PR brouillon, sans diffusion | Référence privée vers une image approuvée du même créateur, nouvelle modération, révisions et révocation. Voir [FANS-PUBLICATION-IMAGES.md](FANS-PUBLICATION-IMAGES.md). |
