...
| Images en quarantaine, lot présent | Implémenté dans cette PR brouillon, opt-in désactivé par défaut | JPEG/PNG normalisés, stockage privé vérifié et attesté, octets réservés aux admins, quotas, retrait/rejet et nettoyage ; aucune diffusion même après approbation. Voir [FANS-IMAGES.md](FANS-IMAGES.md). |
