...
Le [panel de modération Fans](modules/FANS-MODERATION.md) est un adaptateur administratif du module texte optionnel. Il consomme les routes REST existantes, sans accès intermodule aux tables, nouveau moteur ou migration. Images exige toujours son opt-in propre ; aucune diffusion n’est activée.
