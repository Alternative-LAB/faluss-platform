...
final class IdentityClientSchema
{
    public const VERSION = '1';
    public const OPTION = 'faluss_identity_client_schema_version';
    ...
    public static function schema(): array
    {
        return [
            ...
            'states' => [
                'suffix' => 'faluss_identity_client_state',
                'columns' => [
                    'id' => ['type' => 'bigint(20) unsigned', 'null' => false, 'auto' => true],
                    'state_hash' => ['type' => 'char(64)', 'null' => false],
                    'browser_hash' => ['type' => 'char(64)', 'null' => false],
                    'redirect_url' => ['type' => 'varchar(2048)', 'null' => false],
    ...
    public static function maybeInstall(): bool
    {
        return get_option(self::OPTION) === self::VERSION || self::installOrVerify();
    }
    ...
    public static function installOrVerify(): bool
    {
        ...
        $lock = 'faluss_identity_client_' . substr(hash('sha256', $wpdb->prefix), 0, 32);
